...
import TempEvent from "../parts/TempEvent";
  ...
  this.getGroups = function (element) {
    return function (groups) {
      ...
      if (isElementTemporalEvent(element)) {
        groups.push(createTempEventGroup(element, translate));
      }
...
function createTempEventGroup(element, translate) {
  const group = {
    id: "tempEvent-group",
    label: translate("Temporal Event properties"),
    entries: TempEvent(element),
    tooltip: translate("Edit the temporal event values"),
  };
